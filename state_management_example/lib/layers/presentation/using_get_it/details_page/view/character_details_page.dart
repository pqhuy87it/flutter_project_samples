...
import 'package:clean_architecture_example/layers/presentation/using_get_it/injector.dart';
...
class CharacterDetailsPage extends StatelessWidget {
  ...
  static Route<void> route({required Character character}) {
    return MaterialPageRoute(
      builder: (context) {
        getIt<CharacterDetailsController>().character = character;
...
class _Content extends StatelessWidget with GetItMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // no need to watch
    final character = getIt<CharacterDetailsController>().character;
