...
mixin _$CounterStore on _CounterStore, Store {
  Computed<String>? _$doubleCountMessageComputed;

  @override
  String get doubleCountMessage =>
      (_$doubleCountMessageComputed ??= Computed<String>(
        () => super.doubleCountMessage,
        name: '_CounterStore.doubleCountMessage',
      )).value;
  ...
  String toString() {
    return '''
value: ${value},
doubleCountMessage: ${doubleCountMessage}
    ''';
  }
}
